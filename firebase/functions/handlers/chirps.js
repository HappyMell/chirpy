        ...
        .then((data) => {
            if (data.empty) {
                return db
                    ...
                    .then(() => {
                        chirpData.likeCount++;
                        return chirpDocument.update({
                            likeCount: chirpData.likeCount
                        });
